...
- مقصد دیپلوی (Vercel یا جایگزین)، ریجن دیتابیس و مدیریت سکرت‌های `.env` — به انتخاب سرویس SQL (تیکت ۰۹) و معماری (تیکت ۱۲) وابسته است؛ نزدیک انتها.
