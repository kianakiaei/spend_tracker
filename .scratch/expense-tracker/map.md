...
- چرخش به اجرا: وقتی تیکت‌های تصمیم باقی‌مانده (واژه‌نامهٔ سیستمی، مکان تولید الگوها، پیش‌نمایش اقساط) بسته شدند، شکستن پیاده‌سازی به تیکت‌های اجرایی — طبق تصمیم کاربر، این تلاش اجرا را هم خودش حمل می‌کند.
