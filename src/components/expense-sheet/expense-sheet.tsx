...
import { useAutofocusField } from "@/components/ui/use-autofocus-field";
import {
  BTN_GHOST,
  CHIP_CLASS,
  FIELD_CLASS,
...
export function ExpenseSheet({
  ...
  // checks); edit sheets stay keyboard-free. Merged into the same ref the
  // ثبت و جدید path reuses.
