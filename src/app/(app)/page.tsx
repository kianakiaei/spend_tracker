...
export default async function DashboardPage({
  ...
  // Four independent reads; ensure runs inside the first two for the current
  // month (decision 14) — idempotent, so concurrent calls are harmless.
  const [summary, expenses, forecast, categories] = await Promise.all([
